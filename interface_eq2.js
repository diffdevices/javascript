...
var gain_range = 12;        // This value should be positive for standard usage
var gain_clip = 18;
var qors_vals_clip_lo = 0.05;
var qors_vals_clip_hi = 18;

// Filter Data

var num_filters = 2;
var filter_types = [1,0];
    ...
    for (i = 0; i < num_filters; i++)
    {
        ...
        switch (filter_types[i])
        {
            ...
            case 4: // HI SHELF MAX
                ...
                else if (filter_types[i] == 3 || filter_types[i] == 4)
                {
                ...
                {
                    alpha = sinw / (2.0 * qs);
                    alphashelf = 2.0 * A * alpha;
                }
                    
                a0 = 1.0 + alpha / A;
                a1 = -2.0 * cosw;
                a2 = 1.0 - alpha / A;    
                b0 = (1.0 + alphashelf * A) / A;
                b1 = (-2.0 * cosw) / A;
                b2 = (1.0 - alphashelf * A) / A;
...
function ondrag(x, y, but, cmd, shift, capslock, option, ctrl)
{
    ...
    if (select)
    {
        ...
        {    
           ...
           outlet(0, "q", handle + 1, gain_vals[handle]);
